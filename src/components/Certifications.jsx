...
function Certifications() {
  ...
  return (
    <section id="certifications" className="py-20 px-4 bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50 dark:from-blue-900 dark:via-purple-900 dark:to-gray-900 transition-colors duration-500">
