...
import { FaCloud, FaDesktop, FaNetworkWired, FaDatabase, FaWindows, FaTerminal, FaMicrosoftAzure, FaVectorSquare, FaUsers } from 'react-icons/fa';
      ...
      skills: [
        {
          ...
          icon: <FaMicrosoftAzure className="w-8 h-8" />
        },
        {
